...
public class FSM_SelectionPropertiesSubWindow
{
    ...
    IEnumerable<FSM_StateBehaviour> GetAllBehaviourTypes()
    {
    ...
    private void MoveTransitionIndex(int indexIncrement, int transitionsCount)
    {
        ...
        else
        {
            ...
            ((FSM_Manager)_serializedObject.targetObject).ChangeAnyStateTransitionIndex(_selectedTransitionIndex, _selectedTransitionIndex + indexIncrement);
        }
