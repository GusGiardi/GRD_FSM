...
namespace GRD.FSM
{
    ...
    public class FSM_ParametersSubWindow
    {
        ...
        private void DrawParameterBar(SerializedProperty serializedParameter, int parameterIndex)
        {
            ...
            if (parameterIndex != newIndex)
            {
                ...
                if (newIndex < parameterCount)
                {
                    ...
                    ((FSM_Manager)_serializedObject.targetObject).SetParameterIndex(parameterIndex, newIndex);
                }
            }
        ...
        {
            ((FSM_Manager)_serializedObject.targetObject).DeleteParameterAtIndex(parameterIndex);
        }
        #endregion
    }
}
